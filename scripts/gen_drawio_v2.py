...
def build_usecase_file():
    ...
    write_file(os.path.join(OUT_DIR, "06-UseCaseModel-v2.drawio"), pages)
...
def build_activity_file():
    ...
    write_file(os.path.join(OUT_DIR, "07-ActivityDiagrams-v2.drawio"), pages)
...
def build_sequence_file():
    ...
    write_file(os.path.join(OUT_DIR, "08-SequenceDiagrams-v2.drawio"), pages)
